...
function Update() {
    ...
    return (
        <Container fluid>
            <h1 style={{ textAlign: 'center',color:'#ca5252',fontWeight:'bold' }}>Update a Bus</h1>
            <Form id="updateForm" onSubmit={handleFormSubmit} style={{ margin: '0 auto', maxWidth: '600px' }}>
                ...
                <div style={{ textAlign: 'center' }}>
                    <Button variant="primary" type="submit" style={{backgroundColor:'#ca5252',border:'2px solid black'}}>
                        Update 
                    </Button>
                </div>
            </Form>
